...
export const OLLIE_SPRITE_COSTUMES = [
  ...
  },
  {
    ...
    label: "Bowl",
    kind: "image" as const,
    src: "/images/sprites/bowl.png",
    width: 200,
    spriteSheet: { columns: 1, rows: 1 },
    spriteRotationOffsetDeg: -90,
    /** Source uses solid black around the art; runtime keys it out on stage and in previews. */
    chromaKey: { rgb: [0, 0, 0] as const, threshold: 18 },
    spriteCategories: ["objects"] as const,
  },
  {
    ...
    label: "Orange",
    kind: "image" as const,
    src: "/images/sprites/orange.png",
    width: 200,
    spriteSheet: { columns: 1, rows: 1 },
    spriteRotationOffsetDeg: -90,
    chromaKey: { rgb: [0, 0, 0] as const, threshold: 18 },
    spriteCategories: ["objects", "animals"] as const,
  },
  {
    id: "dancingbaby",
    label: "Dancing baby",
...
export const OLLIE_SPRITE_PICKER_ENTRIES: readonly {
  ...
  { costumeId: "bowl", label: "Bowl" },
  { costumeId: "orange", label: "Orange" },
