    ...
    >
      ...
      <div className="relative z-10 mx-auto grid max-w-6xl items-center gap-8 lg:grid-cols-2 lg:gap-10">
        ...
        <div className="flex justify-center lg:justify-end">
          <div
            className="relative isolate h-[min(20rem,80vw)] w-[min(18rem,78vw)] max-w-full overflow-hidden bg-slate-200/40 shadow-[0_28px_64px_-8px_rgba(54,83,20,0.42),0_16px_36px_-10px_rgba(15,23,42,0.22),0_6px_16px_-4px_rgba(15,23,42,0.14)] sm:h-[min(21rem,76vw)] sm:w-[min(19rem,76vw)] lg:h-[24rem] lg:w-[22rem]"
            style={{
              borderRadius: "42% 58% 48% 52% / 36% 44% 56% 64%",
            }}
          >
            <div className="box-border flex h-full min-h-0 w-full min-w-0 items-center justify-center px-5 py-4 sm:px-7 sm:py-5 lg:px-8 lg:py-6">
              <Image
