...
/**
 * Sign-in / sign-up: form on the left, illustration on the right.
  ...
  return (
    <div className="relative min-h-[100dvh] overflow-hidden">
      ...
      <div
        ...
        aria-hidden
      />
      {/* Primary green glow — Ollie brand */}
      <div
      ...
      <div className="relative z-10 flex min-h-[100dvh] flex-col items-center justify-center px-4 py-6 sm:px-6 sm:py-8">
        <div className="grid w-full max-w-6xl grid-cols-1 overflow-hidden rounded-3xl bg-white/95 shadow-2xl ring-1 ring-[#84c126]/10 backdrop-blur-sm lg:grid-cols-2 lg:items-stretch">
          <div className="flex flex-col justify-center px-6 py-8 sm:px-10 sm:py-10 lg:px-12 lg:py-10 xl:px-14">
