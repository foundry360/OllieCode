/*
  Ensures `saved_mission_progress` exists with RLS and PostgREST access.
  Idempotent — safe if 20260405130000_saved_mission_progress.sql already ran.
...
grant select, insert, update on table public.saved_mission_progress to authenticated;
